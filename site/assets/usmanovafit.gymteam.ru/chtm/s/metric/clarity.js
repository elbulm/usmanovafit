...
;(function () {
  ...
  const uid = queryUid || (parentClarityQueryData && parentClarityQueryData.uid) || cookieUid || "9fRMlS4FhXwAL2hUuFLOXethcoDfu02G";
  const sid = (parentClarityQueryData && parentClarityQueryData.sid) || cookieSid || "lcaMbacrxKCDlf53Fhfxdv5r1FWRJ_ik:1783021141288";
  ...
  function trackBehaviour() {
    ...
    const browserSessionId = sessionStorage.getItem('clrt-v8-session-id') || "X-AIyfwWFJonajA9GgpiEkib0az3PeHb";
